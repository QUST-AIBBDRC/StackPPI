...
cv_clf = KNeighborsClassifier(n_neighbors=5,weights="distance",algorithm="auto")
...
yscore_sum.to_csv('M_KNN_yscore.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('M_KNN_ytest.csv')
...
data_csv.to_csv('M_KNN_result.csv')
