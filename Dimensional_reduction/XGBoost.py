...
sio.savemat('yeast_xgb_mask_300.mat',{'mask':mask})
...
yscore_sum.to_csv('Y_test_yscore_300.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('Y_test_ytest_300.csv')
...
data_csv.to_csv('Y_test_result_300.csv')
